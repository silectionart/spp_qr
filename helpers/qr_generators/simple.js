...
const simpleQRGenerator = async (data) => {
  ...
  let qr_png = await brandedQRCode.generate({ text: data, ratio: 8, path: '../../../images/input/logo.png', errorCorrectionLevel: 'L', margin: 1, version: 11 });
  return qr_png;
}
